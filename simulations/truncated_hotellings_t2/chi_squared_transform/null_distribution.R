...
t_val_star <- matrix(nrow = 10000, ncol = 6)
...
sums <- c()
for (i in 1:6) {
  sums[i] <- print(ApproxQuantile(hist(t_val_star[, i], breaks = 500, col = "lightblue", main = "Null Distribution", xlab = "Maximum t-statistic", ylab = "Frequency"), 0.95))
}
